defmodule OrderTimeWeb.OrderControllerTest do
  use OrderTimeWeb.ConnCase

  alias OrderTime.Trade

  @create_attrs %{placing_time: "2010-04-17T14:00:00Z"}
  @update_attrs %{placing_time: "2011-05-18T15:01:01Z"}
  @invalid_attrs %{placing_time: nil}

  def fixture(:order) do
    {:ok, order} = Trade.create_order(@create_attrs)
    order
  end
